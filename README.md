# EM_TEST Configurations

This repository contains all the configuration resources required for the EM_TEST project to function properly and expose its business features.
